...
func TestCheckVersionHelp(t *testing.T) {
	...
	assert.Equal(t, `score-ecs is commonly used in Makefiles and CI pipelines which may depend on a particular functionality
...
Usage:
  score-ecs check-version [constraint] [flags]
